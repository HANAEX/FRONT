  ...
  return (
    <ModalContent className="px-6">
      ...
      <div className="flex justify-between items-center pt-3 mb-1">
        <Text className="font-bold text-xl leading-0 text-slate-600">구매환율</Text>
        <Text className="px-2 py-1 rounded-md bg-slate-400">즉시거래</Text>
      </div>
      {/* 원 input */}
      <WonInput
        selected={selected}
      ...
      />
      <Text className='my-2'>즉시거래할 현재 환율을 선택했어요</Text>

      {/* 원하는 금액 input */}
      <Text className="font-bold text-xl leading-0 text-slate-600 mb-1">원하는 금액</Text>
