...
const FxModal = ({
  ...
  return (
    <ModalContent className="px-6">
      ...
      {/* 원하는 금액 input */}
      <Text className="font-bold text-xl leading-0 text-slate-500 mb-1">
        원하는 금액
      </Text>
      ...
      <div className='flex mt-2'>
        <Text className='font-normal text-xl text-slate-900'>환산금액</Text>
        <Text name="cal-ex">{calculatedValue}</Text>
        <Text className='font-normal text-xl text-slate-900'>약 KRW</Text>
      </div>
      <ModalCloseButton />
