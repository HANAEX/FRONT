  ...
  return (
    <ModalContent className="px-6">
      ...
      <div className="flex justify-between items-center pt-3 mb-1">
        ...
        {/* 만약 */}
        { showClander ? 
          <Text name="예약거래" className="px-2 py-1 rounded-sm bg-yellow-200">예약거래</Text>
          : <Text name="즉시거래" className="px-2 py-1 rounded-sm bg-green-200 border border-red-400">즉시거래</Text>
        }
