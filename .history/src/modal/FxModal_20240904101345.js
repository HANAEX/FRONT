  ...
  return (
    <ModalContent className="px-6">
      ...
      <div className="flex mt-2">
        <Text className="font-normal text-2xl text-slate-500">환산금액</Text>
        <Text className="font-normal text-2xl text-slate-500 mx-2">
          {calculatedValue}
        </Text>
        <Text className="font-normal text-2xl text-slate-500">약 KRW</Text>
      </div>
      <ModalCloseButton />
