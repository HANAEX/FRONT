    ...
    <ModalContent className="px-6">
      ...
      <div className="flex justify-end my-2">
        <div>
          ...
          <Text className="text-xl flex justify-end text-slate-600" as='del'>1389.24</Text>
      ...
      {showClander && 
        <div>
          <Text className="font-bold text-xl leading-0 text-slate-600 mb-1 mt-3">예약가간</Text>
      ...
      <div className="flex mt-2">
        <Text className="font-normal text-2xl text-slate-600">환산금액</Text>
        <Text className="font-normal text-2xl text-slate-600 mx-2">
          {calculatedValue}
        </Text>
        <Text className="font-normal text-2xl text-slate-600">약 KRW</Text>
      </div>
      <ModalCloseButton />

      <div>
        <ModalFooter >
          <Button colorScheme="blue" onClick={handleSetValueAndClose}>
            닫기
          </Button>
          <Button name="구매하기" className="px-2" onClick={onPurchaseClick}>
            구매하기
          </Button>
        </ModalFooter>
      </div>
