...
const NewsCard = ({ state, title, content, image_url, result }) => {
  return (
    <Link to={"/NewsPageDetail"} name="card-container" className='w-[300px] h-[310px] p-3 bg-slate-50 rounded-2xl'>
      {console.log({ image_url })}
      <img src= { image_url } alt='News Image'  className='object-cover rounded-3xl w-full h-[140px]'/>
