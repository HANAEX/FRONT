  ...
  return (
    <div name="card-container" className='w-[250px] h-[310px] px-8 py-5 bg-slate-50 rounded-2xl'>
      ...
      <div name="card-foot" className='flex justify-end'>
        <Text fontSize='2xl' lineHeight={1.2}>8.0%</Text>
      </div>
      <div className='flex justify-between'>
        <Text fontSize='sm' lineHeight={1.1}>현재가</Text>
        <Text fontSize='sm' lineHeight={1.1}>1,300원</Text>
      </div>
      <div className=' flex justify-between'>
        <Text fontSize='sm' lineHeight={1.1}>기준일</Text>
        <Text fontSize='sm' lineHeight={1.1}>2024.05.28</Text>
      </div>
