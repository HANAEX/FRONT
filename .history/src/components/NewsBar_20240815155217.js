      ...
      <div className="w-full bg-slate-300 flex justify-between items-center gap-3">
        ...
        <div name="textbox">
          <div className="flex gap-1">
            <Text className='text-sm font-semibold'>USD/KRW</Text>
            <Text className='text-sm font-semibold text-red-500'>호재</Text>
          </div>
          <Text className='text-sm'>돌아온 '강달러'...원/달러 환율, 1400원 터치 하나?</Text>
