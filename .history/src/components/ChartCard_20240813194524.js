...
const ChartCard = ({ name, increase, imageUrl, currentPrice, date, chartData }) => {
  ...
  return (
    <div to={"/MainPageDetail"} name="card-container" className='w-[250px] h-[350px] px-8 py-5 bg-slate-50 rounded-2xl'>
      {/* card 상단 */}
      ...
      <Text fontSize={'sm'} className='flex justify-end text-slate-600'>자세한 분석 보러가기</Text>
    </div>
  )
}
