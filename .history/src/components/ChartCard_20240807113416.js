  ...
  return (
    <div name="card-container" className='w-[250px] h-[350px] px-8 py-5 bg-slate-50 rounded-2xl'>
      ...
      <div className='flex justify-between'>
        <Text fontSize='sm' color='gray.50' lineHeight={1.2}>현재가</Text>
        <Text fontSize='sm' color='gray.50' lineHeight={1.2}>1,300원</Text>
      </div>
      <div className=' flex justify-between'>
        <Text fontSize='sm' color='gray.50' lineHeight={1.2}>기준일</Text>
        <Text fontSize='sm' color='gray.50' lineHeight={1.2}>2024.05.28</Text>
      </div>
