    ...
    <div className="w-[960px] bg-slate-500 flex flex-col py-1 px-10">
      ...
      > 
        ...
        <div name="right-section" className="bg-slate-50 p-5 flex-1">
          ...
          <div name="1-2" className="bg-slate-400 h-80 mt-6 px-6">
            <Text>주식추전 TOP 3</Text>
            <Divider className='py-2' orientation='horizontal'/>
          ...
          <div name="1-3" className="bg-slate-400 h-80 mt-6"></div>
        </div>
      </div>
