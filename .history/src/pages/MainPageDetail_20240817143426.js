    ...
    <div className="w-[960px] bg-slate-500 flex flex-col py-1 px-10">
      ...
      <Modal isOpen={isOpen} onClose={onClose} isCentered={true}>
        ...
        <ModalContent className='px-4'>
          <Text className='py-6 font-semibold text-lg'>거래하기</Text>
          ...
          <div className='flex justify-end'>
            <Text className='px-2 py-1 rounded-sm bg-slate-400'>예약하기</Text>
          </div>
          <div className='mt-3 flex'>
            <Text className='w-10'>환율</Text>
            <Select icon={<FaPen size="8px"/>} placeholder='1368.1' />
          </div>
