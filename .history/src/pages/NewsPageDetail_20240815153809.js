...
const NewsPageDetail = () => {
  ...
  return (
    <div className="w-[1000px] bg-slate-500 flex flex-col py-1 px-10 mt-10">
      ...
      {/* 요약box */}
      <div name="gpt-box" className="bg-slate-200 px-6 py-4 rounded-md mb-4">
        {gpttext === true ? (
          <Text>{gpt_text}</Text>
        ) : (
      ...
      <div
        name="content-box"
        className="flex flex-col items-center bg-slate-100 rounded-md px-10 py-4"
      >
      ...
      <Text className='text-2xl mt-4 font-semibold'>관련뉴스</Text>
      <NewsBar />
      <NewsBar />
      <NewsBar />
      <NewsBar />
