...
const MainPageDetail = () => {
  ...
  return (
    <div className="w-[1140px] bg-slate-500 flex flex-col py-1 px-10">
      ...
      {/* <div name="recommand-section" className='p-10 flex bg-slate-300 mt-1 gap-10'>
          <div name="left-section" className='bg-slate-50 p-10 flex-none w-64'>
            <Text>US/KRW</Text>
            <div name="1">투자포인트</div>
            <div name="2">추천주식</div>
            <div name="3">추천상품</div>
          </div>
      ...
      >
        <div
          name="left-section"
          className="bg-slate-50 p-10 flex-none w-64 sticky top-0 z-10"
        >
          <Text>US/KRW</Text>
          <div
            name="1"
