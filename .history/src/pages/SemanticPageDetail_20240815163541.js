          ...
          <div className="flex flex-col">
            ...
            <div className="flex justify-between">
              <div className="flex items-end">
                <Text className='text-xl leading-0 bg-red-500'>긍정</Text>
                <Text className='text-2xl font-semibold leading-0 bg-red-500'>
                  81.9%
                </Text>
              </div>
              <div className="flex items-end">
                <Text className='text-2xl font-semibold leading-0 bg-blue-500'>
                  19.1%
                </Text>
                <Text className='text-xl leading-0 bg-blue-500'>부정</Text>
              </div>
            </div>
          </div>
        </div>
