...
const MainPage = () => {
  ...
  useEffect(() => {
    const getUseHistory = async () => {
      try {
        ...
        const result = await axios.get("https://a8068697-21bf-44f7-bf02-fccbc7115c44.mock.pstmn.io/hana");
  ...
  return (
    <>
    <div className='w-[960px] h-[calc(100vh-80px)] bg-slate-500 flex flex-col py-10 px-10'>
